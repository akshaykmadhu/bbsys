...
function matchPassword() {
        ...
        {
            document.getElementById('password').style.borderColor = '#5543ca';
            document.getElementById('passwordconfirm').style.borderColor = '#5543ca';
...
<section class="get-in-touch">
   ...
   <form class="contact-form row" method="post" name="add_user" action="add_user_query.php">
      <div class="form-field col-lg-6">
         <input name="username" id="username" class="input-text js-input" type="text" required>
      ...
      <div class="form-field col-lg-6">
         <input name="password" id="password" onkeyup="matchPassword()" class="input-text js-input" type="text" required>
         <label class="label" for="password">Password</label>
      </div>
      <div class="form-field col-lg-6">
         <input name="passwordconfirm" id="passwordconfirm" onkeyup="matchPassword()" class="input-text js-input" type="text" required>
      ...
      <div class="form-field col-lg-6">
         <input id="age" name="age" class="input-text js-input" type="text" required>
         <label class="label" for="age">Age</label>
      </div>
      <div class="form-field col-lg-6">
            <input id="weight" name="weight" class="input-text js-input" type="text" required>
