    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="patient_dashboard.php"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile</span></a></li>
                        <li><a href="request.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Request Blood</span></a></li>
                        <li><a href="donor_list.php"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Donors</span></a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9 personal-info">
                            ...
                            <h3 style="font-family:resolve-regular;">Personal info</h3>
                            <hr>
                            <form name="profile-update" action="p_profile_update.php" method="post" class="form-horizontal" role="form">
                                <?php
                            ...
                            <div class="form-group">    
                                ...
                                <div class="col-lg-8">
                                  <input class="form-control" type="text" name="email" id="email" value="<?php echo $row['email'];?>" required>
                                </div>
                            </div>
                            <div class="form-group">    
                                <label class="col-lg-3 control-label">Phone Number :</label>
                                <div class="col-lg-8">
                                  <input class="form-control" type="text" name="phone" id="phone" value="<?php echo $row['phone'];?>" required>
                                </div>
                            </div>
                            <div class="form-group">    
                                <label class="col-lg-3 control-label">Age :</label>
                                <div class="col-lg-8">
                                  <input class="form-control" type="text" name="age" id="age" value="<?php echo $row['age'];?>" required>
                                </div>
                            </div>
                              <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                  <div class="ui-select">
                                    <select name="blood_group" id="blood_group" class="form-control" required>
                                        <option value="A+" <?php if($row['blood_group']=="A+") echo 'selected="selected"';?>>A +ve</option>
                                        <option value="A-" <?php if($row['blood_group']=="A-") echo 'selected="selected"';?>>A -ve</option>
                                        <option value="B+" <?php if($row['blood_group']=="B+") echo 'selected="selected"';?>>B +ve</option>	
                                        <option value="B-" <?php if($row['blood_group']=="B-") echo 'selected="selected"';?>>B -ve</option>
                                        <option value="O+" <?php if($row['blood_group']=="O+") echo 'selected="selected"';?>>O +ve</option>
                                        <option value="O-" <?php if($row['blood_group']=="O-") echo 'selected="selected"';?>>O -ve</option>
                                        <option value="AB+" <?php if($row['blood_group']=="AB+") echo 'selected="selected"';?>>AB +ve</option>
                                        <option value="AB-" <?php if($row['blood_group']=="AB-") echo 'selected="selected"';?>>AB -ve</option>
                                    </select>
                                  </div>
                                </div>
                              ...
                              <div class="form-group">    
                                ...
                                <div class="col-lg-8">
                                  <input class="form-control" type="text" name="weight" id="weight" value="<?php echo $row['weight'];?>" required>
                                </div>
                            </div>
                              <div class="form-group">
                              ...
                              <h3 style="font-family:resolve-regular;">Password Change</h3>
                              <hr>
                        <form name="change-pass" action="p_password_update.php" method="post" class="form-horizontal" role="form">
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8">
                                  <input class="form-control" type="password" name="newpass_confirm" id="newpass_confirm" required>
                                </div>
                              </div>
                              <div class="form-group">
                                <label class="col-md-3 control-label"></label>
