    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <!--<div class="logo">
                    <a href="profile.html"><img src="blood-icon.png" alt="Blood Bank GCT" class="hidden-xs hidden-sm"></a>
                </div>-->
                <div class="navi">
                    <ul>
                        <li class="active"><a href="admin_dashboard.php"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile</span></a></li>
                        <li><a href="donor_details.php"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Donor List</span></a></li>
