    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <!--<div class="logo">
                    <br><br>
                    <h3 style="font-family:resolve-bold;color:white">BBSys</h3>
                </div>
...
<section class="get-in-touch">
   ...
   <form class="contact-form row" method="post" name="edit_user" action="edit_user_query.php">
      <div class="form-field col-lg-6">
         <input name="id" id="id" class="input-text js-input" type="text" value="<?php echo $id;?>" readonly required>
         <label class="label" for="id">User ID</label>
      </div>
      <div class="form-field col-lg-6">
         <input name="username" id="username" class="input-text js-input" type="text" value="<?php echo $username;?>" required>
         <label class="label" for="username">Username</label>
      </div>
      <div class="form-field col-lg-6">
         <input name="password" id="password" class="input-text js-input" type="text" value="<?php echo $password;?>" required>
         <label class="label" for="password">Password</label>
      </div>
      <div class="form-field col-lg-6">
         <input name="name" id="name" class="input-text js-input" type="text" value="<?php echo $name;?>" required>
         <label class="label" for="username">Name</label>
      </div>
      <div class="form-field col-lg-6 ">
         <input name="email" id="email" class="input-text js-input" type="email" value="<?php echo $email;?>" required>
         <label class="label" for="email">E-mail</label>
      </div>
       <div class="form-field col-lg-6 ">
         <input name="phone" id="phone" class="input-text js-input" type="text" value="<?php echo $phone;?>" required>
         <label class="label" for="phone">Phone Number</label>
      </div>
      <div class="form-field col-lg-6">
         <input id="age" name="age" class="input-text js-input" type="text" value="<?php echo $age;?>" required>
         <label class="label" for="age">Age</label>
      </div>
      <div class="form-field col-lg-6">
            <input id="weight" name="weight" class="input-text js-input" type="text" value="<?php echo $weight;?>" required>
            <label class="label" for="weight">Weight</label>
        </div>
      <div class="form-field col-lg-6">
            <label for="blood_group" class="label" style="bottom:35px">Blood Group</label>
            <select class="custom-select custom-select-sm input-text js-input" name="blood_group" id="blood_group" required>
                    <option value="A+" <?php if($blood=="A+") echo 'selected="selected"';?>>A +ve</option>
                    <option value="A-" <?php if($blood=="A-") echo 'selected="selected"';?>>A -ve</option>
                    <option value="B+" <?php if($blood=="B+") echo 'selected="selected"';?>>B +ve</option>	
                    <option value="B-" <?php if($blood=="B-") echo 'selected="selected"';?>>B -ve</option>
                    <option value="O+" <?php if($blood=="O+") echo 'selected="selected"';?>>O +ve</option>
                    <option value="O-" <?php if($blood=="O-") echo 'selected="selected"';?>>O -ve</option>
                    <option value="AB+" <?php if($blood=="AB+") echo 'selected="selected"';?>>AB +ve</option>
                    <option value="AB-" <?php if($blood=="AB-") echo 'selected="selected"';?>>AB -ve</option>
            </select>
        </div>
        <div class="form-field col-lg-6">
            <label for="gender" class="label" style="bottom:35px">Gender</label>
            <select class="custom-select custom-select-sm input-text js-input" name="gender" id="gender" required>
