    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile</span></a></li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-9 personal-info">
                            ...
                            <hr>
                            <form name="profile-update" action="d_profile_update.php" method="post" class="form-horizontal" role="form">
                                <?php
                                    include('connection.php');
                                    $username=$_SESSION['username'];
                                    $id=$_SESSION['user_id'];
                                    $query="select * from donor_registration where user_id='$id'";
                            ...
                            <div class="form-group">    
                              ...
                              <hr>
                        <form name="change-pass" action="d_password_update.php" method="post" class="form-horizontal" role="form">
                              <div class="form-group">
...
.navi a:hover {
    background: #0bcfe4 none repeat scroll 0 0;
    border-left: 5px solid #ffffff;
    display: block;
    padding-left: 15px;
}
